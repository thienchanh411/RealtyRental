...
<body>
    ...
    static function showEditFormProfile(User $user, bool $isViewProfile){
    ...
    <section class="probootstrap-section main-section">
		<div class="container">
			<div class="row equal">
				<div <?= $isViewProfile ? "class='col-md-offset-4 col-md-4 padding-0'" : "class='col-md-3 padding-0'" ?>>
				...
				<div class="col-md-9 padding-0" <?= $isViewProfile ? "style='display: none'" : "" ?>>
